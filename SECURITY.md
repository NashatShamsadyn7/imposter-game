...
## ⚠️ P0#2 — تدوير الأسرار المسرّبة (Secret Rotation)

> ⚠️ جهاز التطوير اعتُبر مخترقًا. **اعتبر كل التوكنات التالية مكشوفة** ودوّرها فورًا.
> هذه أفعال على لوحات تحكّم خارجية — يجب أن تنفّذها يدويًا (لا يمكن أتمتتها من الكود).
